  ...
  return (
    <div id="contact-us" style={{backgroundColor: PRIMARY_COLOR, color: PRIMARY_BG_COLOR}} className="p-8">
        ...
        <div className="flex px-8 md:px-32 py-12 gap-4">
            ...
            <form ref={formRef} onSubmit={sendEmail} className="flex-1 flex flex-col px-4 gap-4">
                <div>
                ...
                <div className="flex justify-start">
                    <Button type="submit" variant={"contained"} sx={{bgcolor: `${PRIMARY_COLOR}`, borderRadius: '10000px', padding: '0.6rem 1.2rem', border: `2px solid ${PRIMARY_BG_COLOR}`, color:`${PRIMARY_BG_COLOR}`, textTransform: 'none'}} >
        Send Message
    </Button>
                </div>
            </form>
