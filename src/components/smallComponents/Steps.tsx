...
function Steps() {
  ...
  return (
    <div className="grid grid-cols-1 gap-12 md:px-32">
          <Step step='1' heading='Search for the topic you want to master' description="Go to explore section → Click on / search the topic you want to learn" altText="Search Illustration" image={searchImage} /> 
